...
- [ ] 2.1 Spawned fresh pi session reports per-package verdicts for the 8
  refreshed/audited packages (registration + self-check/tools)
- [ ] 2.2 Any failure captured verbatim into the exploration

## 3. Record

- [ ] 3.1 Exploration `plugin-feature-verification.md` with verdict table
- [ ] 3.2 CHANGELOG entry
- [ ] 3.3 Archive with `skip_specs: true`; `npm run spec:validate` green;
  `npm test` green

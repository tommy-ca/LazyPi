...
That setup is the harness control plane — isolated sub-agents, a structured ask gate, a long-objective gate, side chat, and context budgeting — plus tools (memory, web access, MCP, external directories, interactive shell overlays, model providers), long-running research loops, and themes.

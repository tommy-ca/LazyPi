...
That setup is the harness control plane — isolated sub-agents, a structured ask gate, a long-objective gate, side chat, and context budgeting — plus tools (memory, web access, MCP, interactive shell overlays), long-running research loops, and the curated dark theme pack.
